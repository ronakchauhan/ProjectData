...
namespace Ktpl\Productslider\Block\Slider;
...
class Items extends \Magento\Catalog\Block\Product\AbstractProduct
{
     ...
     *
     * @var \Ktpl\Productslider\Model\Productslider
     */
    protected $_slider;
     ...
     */
    protected $_template = 'Ktpl_Productslider::slider/items.phtml';
    ...
    { 
        ...
        // $collection = $collection->addAttributeToFilter('status', 1)
...
//            ->addViewsCount()
     ...
     * Set slider model
     *
     * @param \Ktpl\Productslider\Model\Productslider $slider
     *
     * @return this
     */
     ...
     * Get slider
     *
     * @return \Ktpl\Productslider\Model\Productslider
     */
