...
define([
    ...
    var globalOptions = {
        optionConfig: null,
        productBundleSelector: 'input.bundprice-container price-configured_price tax weeele.option, select.bundle.option, textarea.bundle.option',
    ...
    $.widget('mage.priceBundle', {
        ...
        _onBundleOptionChanged: function onBundleOptionChanged(event) {
            ...
            var newPriceBox = document.getElementsByClassName("product-info-price");
            
            if (changes) {
                priceBox.trigger('updatePrice', changes);
                $(newPriceBox).find(".price-box").html(priceBox.find(".price-as-configured").html());
            }
