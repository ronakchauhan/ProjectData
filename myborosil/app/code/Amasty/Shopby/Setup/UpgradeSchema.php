...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function addGroupsAttribute(SchemaSetupInterface $setup)
    {
        ...
        $table = $setup->getConnection()
            ...
            ->addForeignKey(
                $setup->getFkName('amasty_amshopby_group_attr_option', 'group_id', 'amasty_amshopby_group_attr',
                    'group_id'),
                'group_id',
            ...
            ->addForeignKey(
                $setup->getFkName('amasty_amshopby_group_attr_option', 'option_id', 'eav_attribute_option',
                    'option_id'),
                'option_id',
        ...
        $table = $setup->getConnection()
            ...
            ->addForeignKey(
                $setup->getFkName('amasty_amshopby_group_attr_value', 'group_id', 'amasty_amshopby_group_attr',
                    'group_id'),
                'group_id',
                $setup->getTable('amasty_amshopby_group_attr'),
                'group_id',
