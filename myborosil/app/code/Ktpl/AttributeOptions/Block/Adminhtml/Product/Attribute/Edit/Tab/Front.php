 ...
 */
namespace Ktpl\AttributeOptions\Block\Adminhtml\Product\Attribute\Edit\Tab;
...
class Front extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                'name'     => 'is_user_guide',
                'label'    => __('User Guide Available'),
                'title'    => __('User Guide Available'),
                'values'   => $yesnoSource,
            ]
        );
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name'     => 'swatch_to_dropdown',
                'label'    => __('Convert Swatch to Dropdown'),
                'title'    => __('Convert Swatch to Dropdown'),
                'values'   => $yesnoSource,
            ]
        );
