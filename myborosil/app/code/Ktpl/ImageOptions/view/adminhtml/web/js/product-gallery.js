...
define([
    ...
    $.widget('mage.productGallery', {
        ...
        _bind: function () {
            this._on({
                ...
                updateBigImage: '_updateBigImage',
                updatePartsImage: '_updatePartsImage',
                updateListImageVisibility: '_updateListImageVisibility',
        ...
        _addItem: function (event, imageData) {
            ...
            imageData = $.extend({
                ...
                'isbigimage': imageData.isbigimage ? imageData.isbigimage : 0,
                'partsimage': imageData.partsimage ? imageData.partsimage : 0,
                'hidefromlisting': imageData.hidefromlisting ? imageData.hidefromlisting : 0,
                'position': count + 1,
    ...
    $.widget('mage.productGallery', $.mage.productGallery, {
        ...
        _initDialog: function () {
            ...
            $dialog.on('change', '[data-role=big-image-trigger]', $.proxy(function (e) {
                var imageData = $dialog.data('imageData');
                this.element.trigger('updateBigImage', {
                    isbigimage: $(e.currentTarget).is(':checked'),
                    imageData: imageData
                })
            }, this));

            $dialog.on('change', '[data-role=hide-image-product-list-trigger]', $.proxy(function (e) {
                var imageData = $dialog.data('imageData');
                this.element.trigger('updatePartsImage', {
                    partsimage: $(e.currentTarget).is(':checked'),
                    imageData: imageData
                })
            }, this));

            $dialog.on('change', '[data-role=parts-image-trigger]', $.proxy(function (e) {
                var imageData = $dialog.data('imageData');
                this.element.trigger('updateListImageVisibility', {
                    hidefromlisting: $(e.currentTarget).is(':checked'),
                    imageData: imageData
                })
            }, this));
         ...
         * @private
         */
        _updateBigImage: function (event, data) {
            var imageData = data.imageData,
                isbigimage = +data.isbigimage,
                $imageContainer = this.findElement(imageData);
            
            !!isbigimage ?
                $imageContainer.addClass('big-image-for-front') :
                $imageContainer.removeClass('big-image-for-front');

            $imageContainer.find('[name*="isbigimage"]').val(isbigimage);
            imageData.isbigimage = isbigimage;
         ...
         * @private
         */
        _updatePartsImage: function (event, data) {
            var imageData = data.imageData,
                partsimage = +data.partsimage,
                $imageContainer = this.findElement(imageData);
            
            !!partsimage ?
                $imageContainer.addClass('product-parts-images') :
                $imageContainer.removeClass('product-parts-images');

            $imageContainer.find('[name*="partsimage"]').val(partsimage);
            imageData.partsimage = partsimage;
         ...
         * @private
         */
        _updateListImageVisibility: function (event, data) {
            var imageData = data.imageData,
                hidefromlisting = +data.hidefromlisting,
                $imageContainer = this.findElement(imageData);
            
            !!hidefromlisting ?
                $imageContainer.addClass('hide-product-images-listing') :
                $imageContainer.removeClass('hide-product-images-listing');

            $imageContainer.find('[name*="hidefromlisting"]').val(hidefromlisting);
            imageData.hidefromlisting = hidefromlisting;
