                ...
                sortedItems.forEach(function(element) {
                    if (element.code == code) {
                        ...
                        if(code == 'payment'){
                            ...
                            $('.step-title').removeClass('step-active');
                            $('#shipping').prev('.custom-step').addClass('step-completed');
                            $('#payment').prev('.custom-step').addClass('step-active');
                            
                        }else if(code == 'shipping'){
                            $('.comment-section').hide();
                            $('.step-title').removeClass('step-active');
                            $('.step-title').removeClass('step-completed');
                            $('#shipping').prev('.custom-step').addClass('step-active');                            
                        }
                        //custom by rakesh end
