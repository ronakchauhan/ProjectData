...
class Layout extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getListingBlockItems()
    {
        ...
        $blockLayout = $this->_getCurrentProduct()->getProductBlock();
     ...
     *
     * @return \Mage\Catalog\Model\Product
     */
    ...
    {
        if($blockArray['type'] == \Ktpl\ProductView\Block\Adminhtml\Options::TYPE_BLOCK)
