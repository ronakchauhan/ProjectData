...
class TagClaud extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Ktpl\Blog\Model\ResourceModel\Tag\CollectionFactory $_tagCollectionFactory
     * @param array $data
     */
    ...
    public function getTags()
    {
        if ($this->_tags === null) {
            ...
            $this->_tags->getSelect()->joinLeft(
                ['pt' => $resource->getTable('ktpl_blog_post_tag')],
                'main_table.tag_id = pt.tag_id',
                []
            )->joinLeft(
                ['p' => $resource->getTable('ktpl_blog_post')],
                'p.post_id = pt.post_id',
                []
            )->joinLeft(
                ['ps' => $resource->getTable('ktpl_blog_post_store')],
