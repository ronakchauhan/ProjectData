 ...
 * Type model
 *
 * @method \Ktpl\Blog\Model\ResourceModel\Tag\Type _getResource()
 * @method \Ktpl\Blog\Model\ResourceModel\Tag\Type getResource()
...
class Type extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'ktpl_blog_tag_type';
     ...
     * @var string
     */
    protected $_eventObject = 'blog_tag_type';
    ...
    {
        $this->_init('Ktpl\Blog\Model\ResourceModel\Tag\Type');
    }
