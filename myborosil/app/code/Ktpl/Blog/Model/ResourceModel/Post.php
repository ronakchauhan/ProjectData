...
class Post extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('ktpl_blog_post', 'post_id');
    }
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'ktpl_blog_post_store', 'store_id');
        ...
        if (is_array($newIds)) {
            ...
            $this->_updateLinks($object, $newIds, $oldIds, 'ktpl_blog_post_tag', 'tag_id');
        }
                ...
                foreach (['post', 'product'] as $linkType) {
                    if (isset($links[$linkType]) && is_array($links[$linkType])) {
                        ...
                        $this->_updateLinks(
                            ...
                            $oldIds,
                            'ktpl_blog_post_related' . $linkType,
                            'related_id',
                            $linksData
                        );
                    }
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds, $isActive = null)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('ktpl_blog_post_store')],
    ...
    {
        return $this->_lookupIds($postId, 'ktpl_blog_post_store', 'store_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'ktpl_blog_post_category', 'category_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'ktpl_blog_post_tag', 'tag_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'ktpl_blog_post_relatedpost', 'related_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'ktpl_blog_post_relatedproduct', 'related_id');
    }
