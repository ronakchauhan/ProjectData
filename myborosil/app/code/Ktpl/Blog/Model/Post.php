 ...
 * Post model
 *
 * @method \Ktpl\Blog\Model\ResourceModel\Post _getResource()
 * @method \Ktpl\Blog\Model\ResourceModel\Post getResource()
...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    const BASE_MEDIA_PATH = 'ktpl_blog';
     ...
     * @var string
     */
    protected $_eventPrefix = 'ktpl_blog_post';
     ...
     * @param \Ktpl\Blog\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory
     * @param \Ktpl\Blog\Model\ResourceModel\Tag\CollectionFactory $tagCollectionFactory
    ...
    public function __construct(
        ...
        \Ktpl\Blog\Model\AuthorFactory $authorFactory,
    ...
    {
        $this->_init('Ktpl\Blog\Model\ResourceModel\Post');
    }
    ...
    /**
     * Retrieve post tags
     * @return \Ktpl\Blog\Model\ResourceModel\Tag\Collection
     */
    ...
    public function getRelatedPosts()
    {
        if (!$this->hasData('related_posts')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('ktpl_blog_post_relatedpost')],
    ...
    public function getRelatedProducts()
    {
        if (!$this->hasData('related_products')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('ktpl_blog_post_relatedproduct')],
    ...
    {
        return \Ktpl\Blog\Helper\Data::getTranslatedDate(
            $format,
